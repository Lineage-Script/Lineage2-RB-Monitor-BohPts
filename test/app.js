const translations = {
  uk: {
    ...
    faq3Q:"Карта працює на телефоні?", faq3A:"???. ????? ????? ???????? ?? ???????? ????? ????????? ????? ??????????? QR-???, ????????? ?? ?? ? ???????? ?????????. ?? ?????? ???????? ????? ?????????? ???? ?? ? ???? ????????? ???????.",
  ...
  ru: {
    ...
    faq3Q:"Карта работает на телефоне?", faq3A:"??. ????? ????? ??????? ?? ???????? ????? ???????? ????? ??????????? QR-???, ????????? ?? ?? ? ???????? ?????????. ? ????? ???????? ????? ????????? ???? ?? ? ???? ????????? ???????.",
  ...
  en: {
    ...
    faq3Q:"Does the map work on mobile?", faq3A:"Yes. The map can be opened on a phone after pairing it with a one-time QR code generated on a licensed PC. One PC and one mobile browser can be linked to each license.",
