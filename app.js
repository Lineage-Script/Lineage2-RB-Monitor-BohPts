const translations = {
  uk: {
    ...
    previewBadge:"Yura RB Monitor • Lineage 2 High Five",
    ...
    faq3Q:"Карта працює на телефоні?", faq3A:"Так. Відкрийте карту на ліцензованому ПК, натисніть «Телефон / QR» і відскануйте одноразовий QR-код. До однієї ліцензії прив’язується один ПК і один мобільний браузер. Звичайне пересилання адреси карти іншому телефону доступу не надає.",
    ...
    downloadNow:"Завантажити Yura RB Monitor", footerNote:"Lineage 2 High Five • OBS/OCR • Raid Boss Timer & Live Map"
  },
  ru: {
    ...
    faq3Q:"Карта работает на телефоне?", faq3A:"Да. Откройте карту на лицензированном ПК, нажмите «Телефон / QR» и отсканируйте одноразовый QR-код. К одной лицензии привязывается один ПК и один мобильный браузер. Обычная пересылка адреса карты другому телефону доступа не предоставляет.",
    ...
    downloadNow:"Скачать Yura RB Monitor", footerNote:"Lineage 2 High Five • OBS/OCR • Raid Boss Timer & Live Map"
  },
  en: {
    ...
    faq3Q:"Does the map work on mobile?", faq3A:"Yes. Open the map on the licensed PC, select “Phone / QR” and scan the one-time QR code. Each license can link one PC and one mobile browser. Sharing the regular map address with another phone does not grant access.",
    ...
    downloadNow:"Download Yura RB Monitor", footerNote:"Lineage 2 High Five • OBS/OCR • Raid Boss Timer & Live Map"
  }
};
...
function setLanguage(lang) {
  ...
  document.title = lang === "en"
    ? "Yura RB Monitor — Lineage 2 Raid Boss Timer"
    : lang === "ru"
      ? "Yura RB Monitor — таймер рейд-боссов Lineage 2"
      : "Yura RB Monitor — таймер рейд-босів Lineage 2";
}
