...
const translations = {
  uk: {
    ...
    heroTitle:"Карта РБ Л2 та таймер рейд-босів<br><span>без ручних секундомірів</span>",
    ...
    ctaKicker:"Менше рутини. Більше гри.", ctaTitle:"Запусти карту РБ і таймери Lineage 2",
  ...
  ru: {
    ...
    previewBadge:"Yura RB Monitor • Lineage 2 High Five • BohPts x500",
    heroTitle:"Карта РБ Л2 и таймер рейд-боссов<br><span>без ручных секундомеров</span>",
    ...
    ctaKicker:"Меньше рутины. Больше игры.", ctaTitle:"Запусти карту РБ и таймеры Lineage 2",
  ...
  en: {
    ...
    previewBadge:"Yura RB Monitor • Lineage 2 High Five • BohPts x500",
    heroTitle:"Lineage 2 raid boss map & timer<br><span>without manual tracking</span>",
    ...
    ctaKicker:"Less routine. More game.", ctaTitle:"Launch your Lineage 2 RB map and timers",
